...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    paymentInfo: "لفتح هذا الإشعار، أرسل 10 MRU عبر إحدى وسائل الدفع أدناه",
  ...
  fr: {
    ...
    lockedNotification: "Appuyez pour débloquer — 10 MRU",
    unlockFor: "Débloquer — 10 MRU",
    ...
    responded: "Répondu",
    pending: "En attente",
    paymentInfo: "Pour débloquer cette notification, envoyez 10 MRU via l'un des moyens de paiement ci-dessous",
