    ...
    <View style={[styles.container, { paddingTop: topPad, paddingBottom: bottomPad }]}>
      ...
      <View style={styles.grid}>
        ...
        <View style={styles.gridRow}>
          ...
          {/* أقرب صيدلية */}
          <TouchableOpacity style={styles.card} onPress={goToNearest} activeOpacity={0.80}>
            <View style={[styles.cardBar, { backgroundColor: "#1565C0" }]} />
          ...
          {/* التمريض المنزلي */}
          <TouchableOpacity style={styles.card} onPress={goToFindDoctor} activeOpacity={0.80}>
            <View style={[styles.cardBar, { backgroundColor: "#00796B" }]} />
            <View style={styles.cardBody}>
        ...
        <View style={[styles.gridRow, { marginTop: 10 }]}>
          ...
          {/* صيدليات المداومة */}
          <TouchableOpacity style={styles.card} onPress={goToDutyDirect} activeOpacity={0.80}>
            <View style={[styles.cardBar, { backgroundColor: "#283593" }]} />
            <View style={styles.cardBody}>
          ...
          {/* سعر الدواء */}
          <TouchableOpacity style={styles.card} onPress={goToDrugPrice} activeOpacity={0.80}>
            <View style={[styles.cardBar, { backgroundColor: "#E65100" }]} />
            <View style={styles.cardBody}>
      ...
      {/* ─── PORTAL LINKS (compact) ─── */}
      <View style={[styles.portalRow, isRTL && styles.rowReverse]}>
        {/* بوابة الصيدليات — خضراء غامقة */}
        <TouchableOpacity
          style={[styles.portalChip, styles.portalChipPharmacy, isRTL && styles.rowReverse]}
        ...
        >
          ...
          <Text style={[styles.portalChipText, isRTL && styles.textRight]} numberOfLines={1}>
            {isRTL ? "بوابة الصيدليات" : "Portail Pharmacies"}
          </Text>
          <Ionicons name={isRTL ? "chevron-back" : "chevron-forward"} size={13} color="rgba(255,255,255,0.8)" />
        </TouchableOpacity>

        {/* بوابة الشركاء — بنفسجية */}
        <TouchableOpacity
          style={[styles.portalChip, styles.portalChipCompany, isRTL && styles.rowReverse]}
        ...
        >
          ...
          <Text style={[styles.portalChipText, { color: "#7C3AED" }, isRTL && styles.textRight]} numberOfLines={1}>
            {isRTL ? "بوابة الشركاء" : "Portail Partenaires"}
          </Text>
          <Ionicons name={isRTL ? "chevron-back" : "chevron-forward"} size={13} color="#7C3AED80" />
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  portalChipPharmacy: {
    backgroundColor: "#047857",   /* أخضر غامق */
  },
  portalChipCompany: {
