              ...
              {isRequestPending ? (
                ...
                <>
                  <View style={styles.paymentHeader}>
                    ...
                    <Text style={[styles.paymentSubtitle, isRTL && styles.rtlText]}>
                      {isRTL
                        ? "أرسل 50 MRU إلى الرقم أدناه. سيتحقق المسؤول ويُفتح الإشعار تلقائياً في هاتفك."
                        : "Envoyez 50 MRU au numéro ci-dessous. Le responsable vérifiera et débloquera automatiquement."}
                    </Text>
                  </View>
                ...
                <>
                  <View style={styles.paymentHeader}>
                    ...
                    <Text style={[styles.paymentSubtitle, isRTL && styles.rtlText]}>
                      {isRTL
                        ? "لفتح هذا الإشعار، اضغط على «طلب فتح» ثم أرسل 50 MRU إلى رقم الدفع. سيتحقق المسؤول ويُفتح الإشعار تلقائياً في هاتفك."
                        : "Pour débloquer, appuyez sur «Demander déblocage» puis envoyez 50 MRU au numéro indiqué. Le responsable vérifiera et débloquera automatiquement."}
                    </Text>
                  </View>
                  ...
                  <View style={styles.stepsBox}>
                    {[
                      ...
                      { n: "2", ar: "أرسل 50 MRU إلى رقم الدفع الظاهر", fr: "Envoyez 50 MRU au numéro affiché" },
                  ...
                  <View style={styles.amountRow}>
                    ...
                    <Text style={styles.amountValue}>50 MRU</Text>
                  </View>
