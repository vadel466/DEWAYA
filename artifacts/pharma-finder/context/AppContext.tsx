...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    lockedNotification: "اضغط لفتح الإشعار مقابل 30 MRU",
    unlockFor: "فتح مقابل 30 MRU",
    ...
    paymentInfo: "لفتح هذا الإشعار، أرسل 30 MRU عبر وسيلة الدفع أدناه",
    payNow: "ادفع الآن — 30 MRU",
  ...
  fr: {
    ...
    lockedNotification: "Appuyez pour débloquer — 30 MRU",
    unlockFor: "Débloquer — 30 MRU",
    ...
    responded: "Répondu",
    pending: "En attente",
    paymentInfo: "Pour débloquer cette notification, envoyez 30 MRU via le moyen de paiement ci-dessous",
    payNow: "Payer maintenant — 30 MRU",
    loading: "Chargement...",
